...
export default function Home() {
  return (
    <main>
      <section className="relative w-full overflow-hidden flex items-center justify-center" style={{ height: 'calc(var(--app-height, 100dvh) + 15px)' }}>
      ...
      <section id="mappa" className="relative w-full bg-[#14110f] overflow-hidden" style={{ height: 'calc(var(--app-height, 100dvh) + 15px)', marginTop: '-15px' }}>
        <MapMonferrato />
      </section>
    </main>
  )
